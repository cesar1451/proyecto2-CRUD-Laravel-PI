...
<div class="py-12">
    <div class="max-w-7x1 mx-auto sm:px6 lg:px-8 duration-300">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">        
            @if (session()->has('message'))
                <div class="bg-teal-100 rounded-b tex-teal-900 px-4 py-4 shadow-md my-3" role="alert">
                    <div class="flex">
                ...
                <tbody>
                    @foreach ($productos as $producto)
                        <tr class="text-center">
                            ...
                            <td class="border px-4 py-2"> {{ $producto->user->name }} </td>
